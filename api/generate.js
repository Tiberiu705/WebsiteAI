      ...
      const gemRes = await fetch(url, {
        ...
        body: JSON.stringify({
          ...
          generationConfig: {
            ...
            temperature: 0.75,
            topP: 0.95,
            // Disable extended thinking on 2.5 models — halves latency for HTML generation
...
@media(max-width:768px){
  ...
  #mob-btn{display:flex!important;position:relative;z-index:9999!important;}
...
(function(){
  ...
  if(!mobBtn||!mobMenu){
    ...
    menu.id='mob-menu';
    menu.style.cssText='display:none;position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(8,8,8,0.98);padding:0 24px;flex-direction:column;align-items:center;justify-content:center;gap:0;z-index:9998;';
    links.forEach(function(el){
      var a=document.createElement('a');
      a.href=el.href||'#';a.textContent=el.textContent.trim();
      a.style.cssText='color:#fff!important;text-decoration:none;font-size:1.25rem;font-weight:600;padding:16px 0;display:block;text-align:center;letter-spacing:0.01em;';
